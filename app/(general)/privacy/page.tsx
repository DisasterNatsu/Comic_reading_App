...
const Privacy = () => {
  return (
    <>
      <title>Privacy - Disaster Scans</title>
      <div className="mt-7 space-y-4 container">
        ...
        <section className="space-y-3">
          <p className="paragraph">
            ...
            <span className="text-yellow-500">https://disasterscans.com</span>,
        ...
        <section className="space-y-3">
          ...
          <p className="paragraph">
            ...
            companies do this and a part of hosting services&rsquo; analytics.
        ...
        <section className="space-y-3">
          ...
          <p className="paragraph">
            Like any other website, Disaster Scans uses &ldquo;cookies&rdquo;.
            These cookies are used to store information including
            visitors&rsquo; preferences, and the pages on the website that the
            visitor accessed or visited. The information is used to optimize the
            users&rsquo; experience by customizing our web page content based on
            visitors&rsquo; browser type and/or other information.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="heading">Google DoubleClick DART Cookie</h2>
          <p className="paragraph">
        ...
        <section className="space-y-3">
          <h2 className="heading">Our Advertising Partners</h2>
          <p className="paragraph">
          ...
          <ul className="list-disc pl-5 md:text-lg text-base text-left">
            <li>
              Google <br />{" "}
              <a
                href="https://policies.google.com/technologies/ads"
                target="_blank"
                className="hover:text-yellow-600 md:text-lg text-base"
              >
                https://policies.google.com/technologies/ads
              </a>
            </li>
        ...
        <section className="space-y-3">
          <h2 className="heading">Privacy Policies</h2>
          <p className="paragraph">
        ...
        <section className="space-y-3">
          <h2 className="heading">Children&rsquo;s Information</h2>
          <p className="paragraph">
        ...
        <section className="space-y-3">
          <h2 className="heading">Online Privacy Policy Only</h2>
          <p className="paragraph">
